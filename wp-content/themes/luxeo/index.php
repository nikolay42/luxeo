<?php get_header(); ?>
        ...
        <section class="blog">
            <div class="container">
                ...
                <div class="blog__filter">
                    <h2 class="blog__filter-link blog__filter-link_cur"  value="all"><i class="material-icons">insert_drive_file</i>ВСЕ СТАТЬИ</h2>
                    <h2 class="blog__filter-link" value="seo"><i class="material-icons">bar_chart</i>SEO</h2>
                    <h2 class="blog__filter-link"  value="smm"><i class="material-icons">insert_drive_file</i>SMM</h2>
                    <h2 class="blog__filter-link"  value="ppc"><i class="material-icons">add_circle_outline</i>PPC</h2>
                </div>
                <!--<ul>
                <?php
                    /*$args = array(
    ...
    'paged'          => get_query_var( 'paged' ),
                 ...
                 <?php while ( $wp_query->have_posts() ) : $wp_query->the_post(); ?>
                    ...
                    <div class="blog__block blog-block" data-id="<?= get_the_ID(); ?>">
                        ...
                        <div class="blog-block__info">
                            ...
                            <p class="blog-block__info-box"><i class="material-icons">visibility</i><?php /*if(function_exists('the_views')) { the_views(); }*/echo do_shortcode('[views id="' . get_the_ID() . '"]'); ?></p>
                            <p class="blog-block__info-box"><i class="material-icons">insert_comment</i><?= get_comments_number() ?></p>
                        </div>
                        <h3 class="blog-block__title"><a href="<?php the_permalink(); ?>" class="blog-block__link"><?php the_title(); ?></a></h3>
